...
function MainSection({downloadLogInfo, update,info, name,recipes,categories}) {
    ...
    return(
        <>
           ...
           <Recipes downloadLogInfo={downloadLogInfo} update={update} info={info} name={name} recipes={recipes} categories={categories}/>
